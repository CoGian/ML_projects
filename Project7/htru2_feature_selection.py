...
plt.axis([0, 1, 0, 1])
plt.plot([fpr[1]], [tpr[1]], marker='o', markersize=3, color="blue")
plt.plot([fpr_pca[1]], [tpr_pca[1]], marker='o', markersize=3, color="red")
plt.plot([fpr_best4[1]], [tpr_best4[1]], marker='o', markersize=3, color="green")
plt.show()